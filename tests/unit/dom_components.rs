use leptos_motion_dom::components::{MotionProps, DragConfig, DragAxis, DragConstraints};
...
fn test_motion_props_with_values() {
    ...
    initial.insert("opacity".to_string(), leptos_motion_core::AnimationValue::Number(0.0));
    
    let mut animate = AnimationTarget::new();
    animate.insert("opacity".to_string(), leptos_motion_core::AnimationValue::Number(1.0));
...
fn test_motion_props_with_gesture_handlers() {
    ...
    hover_target.insert("scale".to_string(), leptos_motion_core::AnimationValue::Number(1.1));
    
    let mut tap_target = AnimationTarget::new();
    tap_target.insert("scale".to_string(), leptos_motion_core::AnimationValue::Number(0.9));
...
fn test_motion_props_with_exit() {
    ...
    exit_target.insert("opacity".to_string(), leptos_motion_core::AnimationValue::Number(0.0));
...
fn test_motion_props_comprehensive() {
    ...
    exit.insert("opacity".to_string(), leptos_motion_core::AnimationValue::Number(0.0));
