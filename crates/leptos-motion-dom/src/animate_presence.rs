...
pub fn create_exit_animation() -> AnimationTarget {
    ...
    target.insert("opacity".to_string(), leptos_motion_core::AnimationValue::Number(0.0));
    target.insert("scale".to_string(), leptos_motion_core::AnimationValue::Number(0.8));
    target
}
...
pub fn create_enter_animation() -> AnimationTarget {
    let mut target = HashMap::new();
    target.insert("opacity".to_string(), leptos_motion_core::AnimationValue::Number(1.0));
    target.insert("scale".to_string(), leptos_motion_core::AnimationValue::Number(1.0));
    target
}
...
mod tests {
    ...
    fn test_presence_manager_animations() {
        ...
        assert_eq!(manager.get_child_animation("child1").unwrap(), &new_animation);
    }
