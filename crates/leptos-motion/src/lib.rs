...
pub use leptos_motion_dom::{
    AnimatePresence, MotionDiv, MotionPath, PresenceMode,
    // Re-export drag types with correct names
    event_driven_motion_div::{DragAxis as EventDragAxis, DragConstraints as EventDragConstraints, DragConfig},
...
mod tests {
    ...
    fn test_version() {
        ...
        assert!(VERSION.contains("1.0") || DESCRIPTION.contains("motion"));
    }
