...
test.describe('Demo DOM Rendering Tests', () => {
  ...
  test('should load WASM files successfully', async ({ page }) => {
    ...
    const wasmJsRequest = requests.find(url => url.includes('comprehensive-demo-cbb9f9e91b5563c5.js'));
    const wasmBgRequest = requests.find(url => url.includes('comprehensive-demo-cbb9f9e91b5563c5_bg.wasm'));
