...
impl TimelineManager {
    ...
    pub fn remove_sequence(&mut self, id: &str) -> (Option<TimelineSequence>, Option<TimelinePlayer>) {
...
pub fn use_timeline() -> (
    ...
    (current_sequence, set_current_sequence, current_target, set_sequences)
}
...
pub mod timeline_utils {
    ...
    pub fn fade_in_sequence(id: String, duration: f64) -> TimelineSequence {
        ...
        let initial_step = TimelineStep::new(
            "initial".to_string(),
            leptos_motion_core::AnimationTarget::from([("opacity".to_string(), leptos_motion_core::AnimationValue::Number(0.0))]),
            0.0,
        );
        
        let fade_step = TimelineStep::new(
            "fade".to_string(),
            leptos_motion_core::AnimationTarget::from([("opacity".to_string(), leptos_motion_core::AnimationValue::Number(1.0))]),
            duration,
        );
    ...
    pub fn scale_sequence(id: String, duration: f64) -> TimelineSequence {
        ...
        let initial_step = TimelineStep::new(
            "initial".to_string(),
            leptos_motion_core::AnimationTarget::from([("scale".to_string(), leptos_motion_core::AnimationValue::Number(0.0))]),
            0.0,
        );
        
        let scale_step = TimelineStep::new(
            "scale".to_string(),
            leptos_motion_core::AnimationTarget::from([("scale".to_string(), leptos_motion_core::AnimationValue::Number(1.0))]),
            duration,
        );
    ...
    pub fn bounce_sequence(id: String, duration: f64) -> TimelineSequence {
        ...
        let bounce_step = TimelineStep::new(
            "bounce".to_string(),
            leptos_motion_core::AnimationTarget::from([("scale".to_string(), leptos_motion_core::AnimationValue::Number(1.2))]),
            duration * 0.3,
        );
...
mod tests {
    ...
    fn test_timeline_step_creation() {
        let target = leptos_motion_core::AnimationTarget::from([
            ("opacity".to_string(), leptos_motion_core::AnimationValue::Number(1.0))
        ]);
