...
pub fn run_app() {
    ...
    web_sys::console::log_1(&"Starting Leptos drag demo mount...".into());
    ...
    // Mount the Leptos component to the fresh #app element
    web_sys::console::log_1(&"Mounting Leptos drag demo component...".into());

    // Use Leptos 0.8 mounting API - mount to body and let it handle the app element
    mount::mount_to_body(|| view! { <DragDemo /> });

    web_sys::console::log_1(&"Leptos drag demo mounted successfully!".into());
}
