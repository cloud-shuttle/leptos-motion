...
#[component]
pub fn SimplifiedComprehensiveDemo() -> impl IntoView {
    ...
    let create_animation_target = |animated: bool| -> HashMap<String, AnimationValue> {
    ...
    let initial_target = create_animation_target(false);
    let animate_target = move || create_animation_target(is_animated.get());
    let transition = move || Transition {
        duration: Some(0.6),
                ...
                <section class="demo-section" style="margin-bottom: 3rem; padding: 2rem; background: #f8f9fa; border-radius: 12px;">
                    ...
                    <div class="button-group" style="display: flex; gap: 1rem; margin-bottom: 2rem; flex-wrap: wrap;">
                        ...
                        <button
                            ...
                            "
                        >
                            {move || if is_visible.get() { "Hide Content" } else { "Show Content" }}
                        </button>
                    </div>
