...
///
/// This tests the MinimalMotionDiv to see if it has the right-click issue
#[component]
pub fn MinimalMotionTest() -> impl IntoView {
    web_sys::console::log_1(&"🎨 MinimalMotionTest: Component created".into());
    ...
    web_sys::console::log_1(&"🎨 MinimalMotionTest: About to render view".into());
    view! {
        <div style="text-align: center; padding: 2rem; background: #282c34; min-height: 100vh; color: white;">
            <h1 style="color: #61dafb; margin-bottom: 2rem;">"Minimal Motion Test"</h1>

            <p style="margin-bottom: 2rem;">"Testing MinimalMotionDiv (no complex effects)"</p>
