...
fn test_variants_basic() {
    ...
    assert_eq!(visible_variant.target.get("opacity").unwrap(), &AnimationValue::Number(1.0));
    assert_eq!(visible_variant.target.get("scale").unwrap(), &AnimationValue::Number(1.0));
}
...
fn test_variants_multiple_states() {
    ...
    assert_eq!(visible.target.get("opacity").unwrap(), &AnimationValue::Number(1.0));
    assert_eq!(hidden.target.get("opacity").unwrap(), &AnimationValue::Number(0.0));
}
...
fn test_variants_with_transitions() {
    ...
    assert_eq!(fade_out.transition.as_ref().unwrap().ease, Easing::EaseInOut);
...
fn test_variants_manager() {
    ...
    assert_eq!(current_target.target.get("opacity").unwrap(), &AnimationValue::Number(1.0));
    ...
    assert_eq!(previous_target.target.get("opacity").unwrap(), &AnimationValue::Number(1.0));
}
...
fn test_variants_complex_targets() {
    ...
    assert_eq!(complex.target.get("opacity").unwrap(), &AnimationValue::Number(1.0));
    assert_eq!(complex.target.get("scale").unwrap(), &AnimationValue::Number(1.2));
    assert_eq!(complex.target.get("rotateZ").unwrap(), &AnimationValue::Number(45.0));
    assert_eq!(complex.target.get("x").unwrap(), &AnimationValue::Number(100.0));
    assert_eq!(complex.target.get("y").unwrap(), &AnimationValue::Number(-50.0));
}
...
fn test_variants_different_value_types() {
    ...
    target.insert("borderRadius".to_string(), AnimationValue::String("50%".to_string()));
    ...
    assert_eq!(mixed.target.get("opacity").unwrap(), &AnimationValue::Number(0.5));
    assert_eq!(mixed.target.get("color").unwrap(), &AnimationValue::String("#ff0000".to_string()));
    assert_eq!(mixed.target.get("borderRadius").unwrap(), &AnimationValue::String("50%".to_string()));
}
...
fn test_variants_performance() {
    ...
    assert_eq!(variant.target.get("opacity").unwrap(), &AnimationValue::Number(0.5));
}
...
fn test_variants_manager_many_transitions() {
    ...
    for i in 0..100 {
        ...
        assert_eq!(current.transition.as_ref().unwrap().duration, Some(i as f64 / 100.0));
    }
}
...
fn test_variants_edge_cases() {
    ...
    assert_eq!(updated_empty.target.get("opacity").unwrap(), &AnimationValue::Number(0.0));
}
