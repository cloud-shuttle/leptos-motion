...
fn App() -> impl IntoView {
    ...
    let initial_values = {
        ...
        initial.insert("x".to_string(), AnimationValue::Number(0.0));
        initial.insert("y".to_string(), AnimationValue::Number(0.0));
        initial.insert("rotation".to_string(), AnimationValue::Number(0.0));
        initial
    };

    // Create transition configuration - use shorter duration for snappier feel
    ...
    view! {
        <div style="padding: 20px; font-family: Arial, sans-serif;">
            ...
            <p>"This demo shows the new ReactiveMotionDivV2 component with proper animation engine integration."</p>
