...
pub mod common_variants {
    ...
    pub fn fade(opacity: f64) -> AnimationTarget {
        ...
        target.insert(
            "opacity".to_string(),
            leptos_motion_core::AnimationValue::Number(opacity),
        );
        target
    }
    ...
    pub fn scale(scale: f64) -> AnimationTarget {
        ...
        target.insert(
            "scale".to_string(),
            leptos_motion_core::AnimationValue::Number(scale),
        );
        target
    }
    ...
    pub fn rotate(rotation: f64) -> AnimationTarget {
        ...
        target.insert(
            "rotateZ".to_string(),
            leptos_motion_core::AnimationValue::Number(rotation),
        );
        target
    }
    ...
    pub fn translate(x: f64, y: f64) -> AnimationTarget {
        ...
        target.insert(
            "x".to_string(),
            leptos_motion_core::AnimationValue::Number(x),
        );
        target.insert(
            "y".to_string(),
            leptos_motion_core::AnimationValue::Number(y),
        );
        target
    }
    ...
    pub fn color(r: f64, g: f64, b: f64) -> AnimationTarget {
        ...
        target.insert(
            ...
            leptos_motion_core::AnimationValue::String(format!("rgb({}, {}, {})", r, g, b)),
        );
        target
    }
}
