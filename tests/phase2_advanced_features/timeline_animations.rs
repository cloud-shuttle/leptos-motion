...
fn test_timeline_keyframe_sequencing(#[case] keyframe_times: Vec<f64>) {
    ...
    let handle = engine.start_timeline(&timeline).expect("Should start timeline");
...
fn test_timeline_scrubbing(#[case] scrub_time: f64) {
    ...
    assert!(
        ...
        expected_opacity, scrub_time, current_opacity
    );
}
...
impl Timeline {
    ...
    pub fn add_keyframe_with_easing(&mut self, time: f64, keyframe: TimelineKeyframe, _easing: Easing) {
    ...
    pub fn scrub_to(&mut self, time: f64) -> Result<(), AnimationError> {
        ...
        Err(AnimationError::NotImplemented("Timeline scrubbing not yet implemented".to_string()))
    }
...
impl AnimationEngine {
    ...
    pub fn start_timeline(&self, _timeline: &Timeline) -> Result<AnimationHandle, AnimationError> {
        Err(AnimationError::NotImplemented("Timeline animations not yet implemented".to_string()))
    }
}
...
mod tests {
    ...
    fn test_keyframe_creation() {
        ...
        assert_eq!(keyframe.properties.get("opacity"), Some(&AnimationValue::Number(1.0)));
