...
fn test_animation_value_to_css_conversion() {
    ...
    assert_eq!(
        animation_value_to_css(&AnimationValue::Pixels(100.0)),
        "100px"
    );
    assert_eq!(
        animation_value_to_css(&AnimationValue::Degrees(45.0)),
        "45deg"
    );
    assert_eq!(
        animation_value_to_css(&AnimationValue::Color("red".to_string())),
        "red"
    );
    assert_eq!(
        animation_value_to_css(&AnimationValue::String("auto".to_string())),
        "auto"
    );
}
